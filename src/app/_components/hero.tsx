...
const Hero = () => {
  return (
    <div className="hero text-neutral-content  bg-hero-pattern xl:bg-none relative min-h-screen">
      ...
      <Container gutter className="items-center justify-center flex-col xl:flex-row relative" style={{ height: 'inherit' }}>
        ...
        <div className="flex lg:flex-row w-full items-center flex-col-reverse xl:flex-row gap-10 relative">
          ...
          <div className="flex-1">
            <div className="max-w-lg">
              <Typography variant="h1" className="text-white text-center lg:text-left text-2xl lg:text-5xl m-auto max-w-[250px] lg:max-w-full" >
