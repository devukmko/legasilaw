...
const Hero = () => {
  return (
    <div className="hero text-neutral-content bg-neutral xl:bg-inherit relative min-h-screen">
      <div className="absolute h-full lg:h-[704px] w-full bg-neutral z-0 top-0 bg-hero-pattern bg-cover hidden xl:block"></div>
        ...
        <Image width={200} height={99} src="/images/logo.png" alt="logo" className="hidden xl:block xl:absolute left-0 top-10" />
          ...
          <div className="flex-1">
            <div className="max-w-lg">
              <Typography variant="h1" className="text-white text-center md:text-left text-2xl lg:text-5xl" >
                Tenang dan nyaman, properti Anda terlindungi.
              </Typography>
              <p className="py-6 text-center md:text-left text-sm lg:text-lg ">
          ...
          <div className=" mt-8 lg:mt-0">
            ...
            <div className="overflow-hidden aspect-auto top-0 right-0 mt-8 md:static hidden lg:block">
              <Image 
                src="/hero.png"
                alt="hero"
                width={531.94}
            ...
            <div className="overflow-hidden aspect-auto top-0 right-0 mt-8 md:static block lg:hidden" style={{ width: 245, height: 250 }}>
              <Image 
                src="/hero.png"
                alt="hero"
                width={245}
