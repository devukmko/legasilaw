          ...
          <div className="flex-[1.6] flex flex-col gap-4">
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-4">
                ...
                >
                  Kami berupaya mengakomodir kebutuhan klien dari awal
                  perencanaan hingga pengelolaan proyek properti yang telah
                  beroperasional. Khususnya bagi pengembang properti yang
                  membutuhkan arahan dan koneksi terkait layanan pendukung di
                  dalam kawasan properti, sehingga klien dapat mengendalikan
                  operasional dan biaya secara efisien. Tim kami mempunyai
                  pengalaman signifikan di bidang pengelolaan kawasan hunian,
                  gedung, dan komersil, akan mendampingi anda dalam menjaga dan
                  memaksimalkan nilai properti.
                </Typography>
              </div>
            </div>
            <div className="flex flex-col gap-4">
